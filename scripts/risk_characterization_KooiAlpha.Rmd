...
```{r include=FALSE}
library(ggmap)
#register with googlemaps
#register_google(key = "AIzaSyBiSSZoq5zG-cY-SLbofYpns4bhXcsjkQQ", write= TRUE)

#SF basemap
sf_basemap <- get_map(location = c(lon = -122.352541, lat = 37.838441), zoom = 9, maptype = 'terrain-background', source = 'stamen')
ggmap(sf_basemap)
