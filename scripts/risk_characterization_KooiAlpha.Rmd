...
THIS SCRIPT IS IDENTICAL TO risk_characterization_ZhuAlpha.Rmd EXCEPT FOR THE SURFACE WATER ALPHA VALUE - WHICH IS SPECIFIC TO KOOI ET AL (2021) AND DERIVED IN THAT PUBLICAITON.
...
max.alpha.marine <- 3.5 
min.alpha.marine <- 1.1 
...
alpha.wastewater.sd <- 0.14
alpha.wastewater.n <- 504

alpha.sediment <- 2.90
alpha.sediment.sd <- 0.41
