...
sample_waterwinsors <- rbin_winsorize(sample_water_cut, predictor = Size_um, Size_um, bins = 100, winsor_rate = 0.05, remove_na = TRUE)
#save as dataframe
...
effluentwinsors <- rbin_winsorize(effluent_cut, predictor = Size_um, Size_um, bins = 100, winsor_rate = 0.05)
#save as dataframe
...
runoffwinsors <- rbin_winsorize(runoff_cut, predictor = Size_um, Size_um, bins = 100, winsor_rate = 0.05)
#save as dataframe
...
sedimentwinsors <- rbin_winsorize(sediment_cut, predictor = Size_um, Size_um, bins = 100, winsor_rate = 0.05)
#save as dataframe
...
tissuewinsors <- rbin_winsorize(tissue_cut, predictor = Size_um, Size_um, bins = 90, winsor_rate = 0.05)
#save as dataframe
