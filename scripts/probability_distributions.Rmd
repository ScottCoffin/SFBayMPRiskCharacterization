...
distributions <- distributions %>% 
  #remove non-plastics
  filter(!PlasticType %in% c("Asphalt", "Cellulosic", "Glass", "Unknown", "Wool", "Anthropogenic (protein base)", 
                             "Anthropogenic (unknown base)", "Cotton", "Inorganic natural material", "Anthropogenic (cellulosic)",
                             "Not Characterized", "Organic natural material", "Uknown Potentially Rubber", 
...
sedimentwinsors <- rbin_winsorize(sediment_cut, predictor = Size_um, Size_um, bins = 20, winsor_rate = 0.05)
#save as dataframe
...
tissuewinsors <- rbin_winsorize(tissue_cut, predictor = Size_um, Size_um, bins = 18, winsor_rate = 0.05)
#save as dataframe
