...
fiber %>% ggplot(aes(x = fiber.adjustment)) + geom_histogram() + scale_x_log10()
...
distributions <- cbind(plastic$plastic.proportion, fiber$fiber.proportion)

colnames(distributions) <- c("plastic.proportion", "fiber.proportion")

summary(plastic$plastic.proportion)
plastic %>% ggplot(aes(x = plastic.proportion)) + geom_histogram() + scale_x_log10()
```
