...
```{r include=FALSE}
spatial_risk_thresholds <- spatial_risk %>% 
  mutate(threshold = case_when(particle.L.master.50 < Threshold1 ~ "< One",
    particle.L.master.50 >= Threshold1 & particle.L.master.50 < Threshold2 ~ "> One",
    particle.L.master.50 >= Threshold2 & particle.L.master.50 < Threshold3 ~ "> Two",
    particle.L.master.50 >= Threshold3 & particle.L.master.50 < Threshold4 ~ "> Three",
    particle.L.master.50 >= Threshold4 ~ "> Four"))
