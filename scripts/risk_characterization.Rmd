...
fiber_hist <- fiber %>% 
  ...
  scale_x_continuous(limits = c(0, 100),
                     breaks = c(0, round(fiber5,0), round(fiber50,0), round(fiber95,0), 100)) +
...
#determine possible candidates with descdist
cullen.frey.plastic <- descdist(plastic.proportions.manta, discrete = FALSE)
cullen.frey.plastic
```
...
plastic_hist <- plastic %>% 
  ...
  scale_x_continuous(limits = c(0, 1),
                     breaks = c(0, round(plastic5,2), round(plastic50,2), round(plastic95,2), 1)) +
...
alpha$alpha <- rtnorm(n = n, mean = m.alpha, sd = sd.alpha, lower = min.alpha, upper = max.alpha)
...
combined.corrections_hist <- combined.distributions %>% 
  ...
  scale_x_continuous(limits = c(0, 20000),
                     breaks = c(round(combined.corrections5,0), round(combined.corrections50,0), round(combined.corrections95,0), 20000, 40000)) +
